...
app.post('/generate_itinerary', async (req, res) => {
    ...
    try {
        const gptResponse = await openai.chat.completions.create({
            ...
            messages: [
                {"role": "system", "content": "You are a professional travel assistant who is adept in planning travel itinerary and optimum travel routes. You are knowledgeable to the aspects of countries when it comes to travel, such as currency, famous local attractions, must try food, transports and so on. You never make things up, and you can access to the internet when you have doubt in your response."},
                {"role": "user", "content": `Create a travel itinerary for ${req.body.city} from ${req.body.startDate} to ${req.body.endDate}. 
