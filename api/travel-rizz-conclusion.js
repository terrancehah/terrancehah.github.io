        ...
        try {
            const gptResponse = await openai.chat.completions.create({
                ...
                messages: [
                    ...
                    Lastly, Do one last page/div for the Farewell Messages consisting about 2-3 sentences, wishing travelers a wonderful journey and inviting them to share their experiences or feedback. Do not prompt travellers to call us, as we are only a travel itinerary helper, not a travel agency.
                    ...
                    For the last page of Farewell Messages, no <h1> title needed, no <p></p> needed, just wrap all the farewell messages sentences into one <h2 id='conclusion'></h2>, you can use <br> to break lines between sentences if you have to.
